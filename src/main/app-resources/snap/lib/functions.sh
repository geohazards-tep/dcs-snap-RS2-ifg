...
function cleanExit ()
{
  ...
  case "${retval}" in
    ...
    ${ERR_NO_URL}) msg="The RADARSAT-2 product online resource could not be resolved";;
    ${ERR_NO_MASTER}) msg="The RADARSAT-2 master product could not be retrieved";;
    ${ERR_NO_SLAVE}) msg="The RADARSAT-2 slave product could not be retrieved";;
